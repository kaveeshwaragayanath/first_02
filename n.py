...
def tx_rx_tone(freq, chan=0, fs=31.25e6, gain=0, rx_gain=30, buff_len=16384):
    ...
    # The manual gain setting lines are intentionally commented out/removed
    # to enforce AGC control, fulfilling the user's request.
...
def parse_command_line_arguments():
    ...
    # NOTE: -r argument is kept for compatibility but its value is ignored 
    # as we now force AGC.
